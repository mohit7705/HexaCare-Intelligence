        ...
        <div className="lg:grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="mb-12 lg:mb-0">
            ...
            <p className="font-sans text-xl text-bodyText mb-8">
              Get in touch to schedule a demo of the HexaCare platform or learn more about our enterprise APIs.
            </p>
            <div className="space-y-4">
               <div className="flex items-center space-x-3 text-navy">
                 <div className="w-2 h-2 rounded-full bg-green-500"></div>
                 <span className="font-medium">Sales Team Available: 9am - 5pm EST</span>
               </div>
               <div className="flex items-center space-x-3 text-navy">
                 <div className="w-2 h-2 rounded-full bg-techBlue"></div>
                 <span className="font-medium">Technical Support: 24/7</span>
               </div>
            </div>
          </div>

          {/* Right Side Form */}
          <div className="bg-white/80 backdrop-blur-xl border border-skyGlow/20 rounded-3xl p-8 shadow-2xl relative overflow-hidden h-auto min-h-[460px]">
            {isSuccess ? (
              ...
              <form className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-techBlue focus:ring-2 focus:ring-techBlue/20 outline-none transition-all bg-white/50"
                    placeholder="I'm interested in integrating HexaCare..."
                  ></textarea>
                </div>
